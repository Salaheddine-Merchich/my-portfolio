  ...
  return (
    <footer className={`py-12 border-t transition-all duration-300 ${
      ...
      >
        ...
        <p className={`flex items-center gap-2 text-lg font-medium ${isDark ? "text-gray-300" : "text-gray-600"}`}>
          Made with <Heart size={18} className="text-red-500 fill-red-500 animate-pulse" /> by Salaheddine Merchich
        </p>
        
        <p className={`text-sm tracking-wide ${isDark ? "text-gray-500" : "text-gray-400"}`}>
          Built with <span className="text-primary font-bold">React</span> + <span className="text-primary font-bold">Tailwind CSS</span> + <span className="text-primary font-bold">Framer Motion</span>
        </p>
